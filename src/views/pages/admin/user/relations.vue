    ...
    export default {
        ...
        methods: {
            getDataResponse(data) {
                return data.user.relatedOrganizations ? data.user.relatedOrganizations : [];
            },
            getDataQuery() {
                return QueryByUser;
            },
                ...
                if (!this.createForm.organizations.length) {
                    this.$apollo.query({
                        ...
                        let array = data.organizations.data.map((currentValue, index, array) => {
                            return {value: currentValue.id, text: currentValue.shortName?currentValue.shortName:currentValue.name}
                        });
