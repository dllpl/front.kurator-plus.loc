        ...
        <b-card-body>
          ...
          <b-row class="mb-2">
            ...
            <b-col md="2">
              ...
              <b-form-invalid-feedback v-if="$v.inn.$error">
          ...
          <b-row class="mb-2">
            ...
            <b-col md="2">
              <b-input name="birthDate" type="date" v-model="model.dirty.birthDate"></b-input>
            </b-col>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.getData();
            this.redirectUrl = {name: this.$route.meta.role + '-stream-user', params: this.$route.params}
        },
        methods: {
        ...
        validations: {
            inn: {
                valid() {
                    return Boolean(this.model.dirty.inn) && (this.model.dirty.inn.replace(/[^0-9]/g, '').length === 12);
                }
            },
            phone: {
                valid() {
