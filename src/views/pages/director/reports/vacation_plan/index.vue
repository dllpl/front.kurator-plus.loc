  ...
  export default {
    ...
    methods: {
      ...
      getDataResponse(data) {
        data.vacationPlans.data = data.vacationPlans.data.filter((item) => {
          return ['reject', 'saved'].find(itemS => item.status === itemS) === undefined
        });
      ...
      getStreams() {
        this.$apollo.query({
          ...
          this.streams = data.organization.learningStreams.data;
        });
      },
      isEditableItem() {
        return false;
