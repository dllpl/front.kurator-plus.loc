      ...
      <slot v-else>
        <b-card-body>
          ...
          <b-row class="mb-2">
            ...
            <b-col md="2">
              <b-input name="email" type="email" v-model="model.dirty.email" :state="(!$v.email.$error)?null:false"/>
          ...
          <hr v-if="role !== 'stream_leader'"/>
          <b-row class="mb-2" v-if="role !== 'stream_leader'">
